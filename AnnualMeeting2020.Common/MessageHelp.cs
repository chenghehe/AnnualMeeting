...
namespace AnnualMeeting2020.Common
{
    ...
    public static class MessageHelp
    {
        ...
        /// <returns></returns>
        public static string MessageFilter(this string msg)
        {
            var arr = sensitiveTexts.Split('|');
